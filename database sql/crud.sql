...
--
-- Host: localhost
-- Generation Time: Aug 10, 2019 at 07:13 AM
...
(4, 'Aliya Langworth MD', '9492 Hand Ville', 'misty46@example.net'),
...
(202, 'Arif Parjuni', 'Dorowati kebumen JATENG', 'sierra.bogisich@example.net');
...
--
ALTER TABLE `peoples`
  MODIFY `id` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
COMMIT;
